      ...
      <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl overflow-hidden relative z-10 animate-in fade-in zoom-in duration-300">
        ...
        <div className="p-8 pt-6">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="email"
                  required
                  className="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-[#0284c7] focus:ring-1 focus:ring-[#0284c7] transition-all bg-gray-50 focus:bg-white"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-[#0284c7] focus:ring-1 focus:ring-[#0284c7] transition-all bg-gray-50 focus:bg-white [&::-ms-reveal]:hidden"
                  placeholder="••••••••"
                  value={password}
                ...
                <button
                  ...
                  className="absolute right-3 top-3 text-gray-400 hover:text-[#0284c7] transition-colors focus:outline-none"
                >
            ...
            <button
              disabled={loading}
              className="w-full bg-[#0f172a] text-white font-bold py-3 rounded-lg hover:bg-[#020617] active:scale-[0.98] transition-all flex items-center justify-center shadow-lg shadow-[#0f172a]/20"
            >
          ...
          <div className="mt-8 text-center border-t border-gray-100 pt-6">
            <Link href="/" className="inline-flex items-center gap-2 text-xs font-bold text-gray-400 hover:text-[#0284c7] transition-colors">
